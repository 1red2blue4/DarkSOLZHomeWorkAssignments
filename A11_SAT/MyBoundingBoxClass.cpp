...
bool MyBoundingBoxClass::IsCollidingSimple(MyBoundingBoxClass* other)
{
...
std::vector<vector3> MyBoundingBoxClass::GetCorners()
{
	vector3 maxXmaxYmaxZ = vector3(m_v3MaxGlobal.x, m_v3MaxGlobal.y, m_v3MaxGlobal.z);
	vector3 maxXmaxYminZ = vector3(m_v3MaxGlobal.x, m_v3MaxGlobal.y, m_v3MinGlobal.z);
	vector3 maxXminYmaxZ = vector3(m_v3MaxGlobal.x, m_v3MinGlobal.y, m_v3MaxGlobal.z);
	vector3 maxXminYminZ = vector3(m_v3MaxGlobal.x, m_v3MinGlobal.y, m_v3MinGlobal.z);
	vector3 minXmaxYmaxZ = vector3(m_v3MinGlobal.x, m_v3MaxGlobal.y, m_v3MaxGlobal.z);
	vector3 minXmaxYminZ = vector3(m_v3MinGlobal.x, m_v3MaxGlobal.y, m_v3MinGlobal.z);
	vector3 minXminYmaxZ = vector3(m_v3MinGlobal.x, m_v3MinGlobal.y, m_v3MaxGlobal.z);
	vector3 minXminYminZ = vector3(m_v3MinGlobal.x, m_v3MinGlobal.y, m_v3MinGlobal.z);
	std::vector<vector3> corners = { maxXmaxYmaxZ, maxXmaxYminZ, maxXminYmaxZ, maxXminYminZ, minXmaxYmaxZ, minXmaxYminZ, minXminYmaxZ, minXminYminZ };
