...
#pragma region Camera Positioning
	...
	{
		m_boMngr->SetVisibility(0, false);
		m_boMngr->SetVisibility(1, false);
		m_boMngr->SetVisibility(2, false);
	}
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::P))
	{
		m_boMngr->SetVisibility(0, true);
		m_boMngr->SetVisibility(1, true);
		m_boMngr->SetVisibility(2, true);
	}
#pragma endregion
