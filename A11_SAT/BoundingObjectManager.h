...
public:
	...
	static void ToggleSphereVisibility(int index);
	static int GetNumBO();
	...
	static MyBoundingBoxClass* GetBox(int index);
	static MyBoundingSphereClass* GetSphere(int index);
	static SATClass* GetSAT(int index);
};