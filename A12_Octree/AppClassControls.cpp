...
void AppClass::ProcessKeyboard(void)
{
	...
	static bool timedEventPressed = false;
...
#pragma endregion
	...
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::O) && !timedEventPressed)
	{
		usingOctree = !usingOctree;
		savedTime = timer;
		timedEventPressed = true;
	}

	if (sf::Keyboard::isKeyPressed(sf::Keyboard::R) && !timedEventPressed)
	{
	...
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::C) && !timedEventPressed)
	{
		calcOctree = !calcOctree;
		savedTime = timer;
		timedEventPressed = true;
	}
	...
	if (timer > savedTime + 15.0f)
	{
		timedEventPressed = false;
	}
